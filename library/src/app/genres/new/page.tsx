    ...
    <main className="p-8 max-w-2xl mx-auto">
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8">
        <header className="flex justify-between items-center mb-8">
          <h1 className="text-2xl font-bold">Añadir Nuevo Género</h1>
          <Link href="/genres" className="text-sm text-gray-500 hover:text-gray-900">
            ← Volver a géneros
          </Link>
        </header>
        ...
        <form action={createGenre} className="flex flex-col gap-6">
          <div>
